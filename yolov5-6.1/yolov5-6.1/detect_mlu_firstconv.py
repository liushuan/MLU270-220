...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    if opt.cfg == 'qua':
        qconfig = {'iteration':iter_size, 'firstconv':True, 'use_avg':False, 'mean':[0,0,0], 'std':[1, 1, 1], 'data_scale':1.0, }
        ...
        if opt.jit:
            ...
            ct.save_as_cambricon('weights_safe_head_person/yolov5_220_'+str(batch_size) + '_'+ str(core_number))
